...
namespace EllAid.DataSource.DataAccess.Context
{
    public class PeopleContext : DbContext
    {
        ...
        public PeopleContext(DbContextOptions<PeopleContext> options, IConfiguration config) : base(options)
        {
            ...
            partitionKey = config["DataStore:Containers:People:PartitionKey"];
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InstructorDto>().HasPartitionKey(partitionKey);
            ...
            modelBuilder.Entity<EllCoachDto>().HasPartitionKey(partitionKey);
            ...
            modelBuilder.Entity<AssistantDto>().HasPartitionKey(partitionKey);
